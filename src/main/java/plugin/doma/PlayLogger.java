...
public class PlayLogger implements JdbcLogger {
    ...
    /**
     * {@link java.sql.Connection#setAutoCommit(boolean)} の引数に {@code true} を渡した時に発生した
    ...
    /**
     * {@link java.sql.Connection#setTransactionIsolation(int)} 時に発生した
     * {@link SQLException} を記録します。
     *
     * @param callerClassName
     * @param callerMethodName
    ...
    public void logTransactionIsolationSettingFailuer(String callerClassName,
                                                      ...
                                                      SQLException e) {
        Logger.error(Message.DOMA2072.getMessage(transactionIsolationLevel), e);
    }

    /**
     * {@link java.sql.Connection#close()} 時に発生した {@link SQLException} を記録します
     *
     * @param callerClassName
     * @param callerMethodName
     * @param e
    ...
    public void logConnectionClosingFailure(String callerClassName,
                                            String callerMethodName, SQLException e) {
        Logger.error(Message.DOMA2073.getMessage(), e);
    }

    /**
     * {@link java.sql.Statement#close()} 時に発生した {@link SQLException} を記録します
     *
     * @param callerClassName
     * @param callerMethodName
     * @param e
    ...
    public void logStatementClosingFailure(String callerClassName,
                                           String callerMethodName, SQLException e) {
        Logger.error(Message.DOMA2074.getMessage(), e);
    }

    /**
     * {@link java.sql.ResultSet#close()} 時に発生した {@link SQLException} を記録します
     *
     * @param callerClassName
     * @param callerMethodName
     * @param e
    ...
    public void logResultSetClosingFailure(String callerClassName,
                                           String callerMethodName, SQLException e) {
        Logger.error(Message.DOMA2075.getMessage(), e);
    }
